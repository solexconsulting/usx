...
// Enhanced by @uswds/uswds/js/usa-character-count at runtime (call ONLY
// characterCount.init() in the consuming app/story, never .on()/.off() — see
// Combobox.tsx for why). That script moves the field's `maxlength` attribute
// to `data-maxlength`, hides this fallback message, and creates/updates the
// live status text and error state itself — React only renders the
// pre-enhancement markup the twig contract expects.
