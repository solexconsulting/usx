...
function renderDisclaimer({ language, parentAgencies, taxpayerDisclaimer }) {
        ...
        <div className="usa-identifier__container">
          <ul className="usa-identifier__required-links-list">
            {links.map((link, index) => (
              <li className="usa-identifier__required-links-item" key={`${link.label || link}-${index}`}>
...
Identifier.propTypes = {
  ...
  parentAgencies: PropTypes.arrayOf(PropTypes.shape({
  ...
  logoShape: PropTypes.oneOf([null, 'circle', 'rounded-sm', 'rounded-md', 'rounded-lg', 'rounded-xl']),
  requiredLinks: PropTypes.arrayOf(PropTypes.oneOfType([
    PropTypes.string,
    PropTypes.shape({
      href: PropTypes.string,
