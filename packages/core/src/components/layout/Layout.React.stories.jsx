...
export const GridFullContent = Template.bind({});
GridFullContent.args = {
  variant: 'grid',
  content: (
...
export const GridWithLeftSidebar = Template.bind({});
GridWithLeftSidebar.args = {
  variant: 'grid',
...
export const GridWithRightSidebar = Template.bind({});
GridWithRightSidebar.args = {
  variant: 'grid',
  content: (
    <div style={{ background: '#e8f4f8' }}>
