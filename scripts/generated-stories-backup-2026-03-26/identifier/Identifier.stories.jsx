...
import Component from './Identifier.jsx';
...
export const ReactView = {
  ...
  parameters: {
    docs: {
      source: {
        code: componentTag({ name: 'identifier', props: config.default || {} })
      }
    }
  },
...
export const HTMLView = {
  ...
  render: () => componentTag({ name: 'identifier', props: config.default || {} })
};
...
export const DjangoView = {
  ...
  render: djangoComponent('identifier')
};
