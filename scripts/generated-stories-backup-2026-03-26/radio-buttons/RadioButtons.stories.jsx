...
import Component from './RadioButtons.jsx';
...
export const ReactView = {
  ...
  parameters: {
    docs: {
      source: {
        code: componentTag({ name: 'radio-buttons', props: config.default || {} })
      }
    }
  },
...
export const HTMLView = {
  ...
  render: () => componentTag({ name: 'radio-buttons', props: config.default || {} })
};
