...
import Component from './SideNav.jsx';
...
export const ReactView = {
  ...
  parameters: {
    docs: {
      source: {
        code: componentTag({ name: 'side-nav', props: config.default || {} })
      }
    }
  },
...
export const HTMLView = {
  ...
  render: () => componentTag({ name: 'side-nav', props: config.default || {} })
};
...
export const DjangoView = {
  ...
  render: djangoComponent('side-nav')
};
